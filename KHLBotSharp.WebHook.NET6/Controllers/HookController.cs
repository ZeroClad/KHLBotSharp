...
namespace KHLBotSharp.WebHook.NetCore3.Controllers
{
    public class HookController : Controller
    {
        ...
        public IActionResult Fuck()
        {
            ...
            if (ip != null)
            {
                logService.Warning(ip + " had accessed our bot illegally, lets send him to Tong Shen Serving Hot Pot");
            }
            else
            {
                logService.Warning("Someone had accessed our bot illegally, lets send him to Tong Shen Serving Hot Pot");
            }
