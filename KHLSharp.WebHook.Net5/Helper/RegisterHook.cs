...
namespace KHLBotSharp.WebHook.Net5.Helper
{
    public static class RegisterHook
    {
        public static IServiceCollection RegisterWebhook(this IServiceCollection service)
        {
            ...
            foreach (var bot in botInstances)
            {
                ...
                var hookInstance = new HookInstance();
